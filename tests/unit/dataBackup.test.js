...
describe('validateBackup', () => {
  ...
  // Regression coverage for the Mazaosmart rebrand: this feature has been
  // live for several releases before the rebrand happened, so real users
  // may already have downloaded backups carrying the pre-rebrand marker
  // as their safety net. Breaking those on restore would undermine the
  // entire point of a backup — being there when it's actually needed,
  // which could be well after it was made.
