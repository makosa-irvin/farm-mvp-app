...
export function validateBackup(payload) {
  ...
  if (payload.version !== BACKUP_VERSION) throw new Error(`Unsupported backup version: ${payload.version ?? 'unknown'}.`);
  if (!payload.data || typeof payload.data !== 'object') throw new Error('The backup does not contain farm data.');
  return {
